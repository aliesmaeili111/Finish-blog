...
def activate(request, uidb64, token):
    ...
    if user is not None and account_activation_token.check_token(user, token):
        ...
        return HttpResponse("ممنونیم از شما،حساب کاربری شما با موفقیت فعال شد برای ورود <a href='/login'></a> کنید")
    else:
        return HttpResponse("لینک فعالسازی منقضی شده است. لطفا دوباره امتحان کنید.<a href='/register'></a>")
